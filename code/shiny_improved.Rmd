...
seaford_font_path <- here("fonts/19722397430.ttf")
...
# Load Data
df1 <- import("data/corp_76to20_bystate_MGyearrecoded.xlsx")
df2 <- import("data/suspensions_72to21_bystate_MGyearrecoded.xlsx")
df3 <- import("data/treatment dataset_2year.xlsx")
